(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        forms.forEach(form => {
            ...
            const resetLink = form.querySelector('.sikada-lost-password-link');
            if (resetLink && window.sikadaAuthData && window.sikadaAuthData.passwordResetUrl) {
    ...
    async function handleLogin(e) {
        ...
        submitButton.textContent = (window.sikadaAuthData && window.sikadaAuthData.labels && window.sikadaAuthData.labels.loading)
        ...
        try {
            ...
            if (data.success) {
                ...
                // Show error message
                showMessage(messagesContainer, data.data.message || 'Login failed', 'error');
