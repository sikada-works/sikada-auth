(function () {
    ...
    async function handleResetPassword(e) {
        ...
        if (password !== confirmation) {
            showMessage(messagesContainer, (window.sikadaAuthData && window.sikadaAuthData.labels && window.sikadaAuthData.labels.mismatch)
        ...
        if (!key || !login) {
            showMessage(messagesContainer, 'Invalid reset link. Please request a new one.', 'error');
            return;
        }
        ...
        submitButton.textContent = (window.sikadaAuthData && window.sikadaAuthData.labels && window.sikadaAuthData.labels.saving)
        ...
        try {
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    } else if (window.sikadaAuthData && window.sikadaAuthData.loginUrl) {
                ...
                // Show error message
                showMessage(messagesContainer, data.data.message || 'Reset failed', 'error');
